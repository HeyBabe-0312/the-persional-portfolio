export const projects = [
  ...
  {
    title: 'Memories App',
    description: "The App is called 'Memories' and it is a simple social media MERN application that allows users to post interesting events that happened in their lives. Some function like login with Email (JWT) + Google OAuth Authentication, pagination, title & tags search, post details page and comment.",
    descriptionJP: 'このアプリは「Memories」と呼ばれ、ユーザーが人生で起こった興味深い出来事を投稿できるシンプルなソーシャル メディア MERN アプリケーションです。メール「(JWT)+Google OAuth」認証によるログイン、ページネーション、タイトル&タグ検索、投稿詳細ページ、コメントなどの機能があります。',
    descriptionVN: 'Ứng dụng này được gọi là "Memories" và nó là một ứng dụng MERN trên phương tiện truyền thông xã hội đơn giản cho phép người dùng đăng các sự kiện thú vị đã xảy ra trong cuộc sống của họ. Một số chức năng như đăng nhập bằng Email (JWT) + Xác thực OAuth của Google, phân trang, tìm kiếm tiêu đề & thẻ và trang chi tiết bài đăng và nhận xét.',
    image: 'https://firebasestorage.googleapis.com/v0/b/musicupload-7dde0.appspot.com/o/Image%2Fmemorymain.png?alt=media&token=920362f3-d2bd-4607-9871-830840af34b5',
